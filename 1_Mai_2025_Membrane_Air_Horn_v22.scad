...
////Message: 1
STRINGOFTEXT_BlowCan="Rider unite, together we fight!";  // (37 charackters)
FONTWIDTHSTRING_BlowCan=[0.00,2.425,0.50,1.80,1.80,0.95,0.7,1.80,1.80,0.5,0.70,1.80,0.7,0.7,0.75,1.80,1.80,1.80,0.70,1.75,1.8,0.95,0.7,2.45,1.80,0.7,0.70,0.5,1.8,1.75,0.75,];
//
////Message: 2
STRINGOFTEXT_Cover="1. Mai 2025";  // (11 charackters)
