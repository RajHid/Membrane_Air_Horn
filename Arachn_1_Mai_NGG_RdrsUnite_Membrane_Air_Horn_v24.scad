...
////Message: 1
STRINGOFTEXT_BlowCan="Riders unite, together we fight!";  // (38 charackters)
FONTWIDTHSTRING_BlowCan=[0.00,2.425,0.50,1.80,1.80,0.95,1.55,0.7,1.80,1.80,0.5,0.70,1.80,0.7,0.7,0.75,1.80,1.80,1.80,0.70,1.75,1.8,0.95,0.7,2.45,1.80,0.7,0.70,0.5,1.8,1.75,0.75,];
//
////Message: 2
//STRINGOFTEXT_Cover="NGG, 1. Mai";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[ 0.00,1.8,0.70,0.70,2.85,1.80,0.5,0.7,1.80,1.80,1.80];

////Message: 3.1
//STRINGOFTEXT_BlowCan="Nur gemeinsam geht's";  // (38 charackters)
//FONTWIDTHSTRING_BlowCan=[0.00,2.45,1.8,-0.2,1.80,1.80,1.8,2.85,1.80,0.50,1.80,1.55,1.8,1.775,1.8,1.80,1.80,1.80,0.70,0.4];
////Message: 3.2
//STRINGOFTEXT_BlowCan="Nur gute Gründe";  // (38 charackters)
//FONTWIDTHSTRING_BlowCan=[0.00,2.425,0.50,1.80,1.80,0.95,1.55,0.7,1.80,1.80,0.5,0.70,1.80,0.7,0.7,0.75,1.80,1.80,1.80,0.70,1.75,1.8,0.95,0.7,2.45,1.80,0.7,0.70,0.5,1.8,1.75,0.75,];
//////Message: 3.3
//STRINGOFTEXT_BlowCan="Nur gute Gründe";  // (38 charackters)
//FONTWIDTHSTRING_BlowCan=[0.00,2.425,0.50,1.80,1.80,0.95,1.55,0.7,1.80,1.80,0.5,0.70,1.80,0.7,0.7,0.75,1.80,1.80,1.80,0.70,1.75,1.8,0.95,0.7,2.45,1.80,0.7,0.70,0.5,1.8,1.75,0.75,];
////
//////Message: 4
//STRINGOFTEXT_Cover="1._Mai: NGG!";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[ 0.0,1.80,0.20,1.5,2.85,1.80,0.5,1.80,1.80,1.80,1.80,1.80,1.80];
////Message: 4
STRINGOFTEXT_Cover="1. Mai: NGG";  // (11 charackters)
FONTWIDTHSTRING_Cover=[0.00,1.80,0.425,1.0,2.85,1.80,0.50,0.425,1.00,2.45,2.65,1.00];
    ...
    see_me_half(){
        ...
        translate([0,0,/*BlowCanHeight/4*/0]){
            CYLINDER_EMBOSSER(  STRINGOFTEXT_BlowCan,
                                ...
                                Vector_BlowCan,
                                0.0,                       // Ascend Step
                                10                          // WAS: Text_Ascend_Deg            // Ascend degree
                                );
        }
        translate([0,0,0]){
            CYLINDER_EMBOSSER(  STRINGOFTEXT_BlowCan,
...
//                                            4.5);       // Spiral_Ascend_Deg  fix value of degree each letter gets rotatet out of vertical to line up the String as it is writen in a nice spiral
        ...
        // Hanger hole
        translate([-BlowCanDiameter/2+2.25,0,0]){
            rotate([0,-42,0]){
                scale([1,2,1]){
        ...
        // Bottom incision
        cylinder(h=BottomHeight/1.5,d2=Tube_d,d1=BlowCanDiameter-(BlowCanDiameter-Tube_d)/1.5,$fn=FN_USED); //Tube_d+2*WallThickness_Tube
        translate([0,0,BottomHeight/2]){
            Ring_Lip(   1,
                        BlowCanDiameter/2+(BlowCanDiameter/2)*0.02,
                        2,
                        3.25,
                        "no"
                        );
        ...
        mirror([0,0,1]){
            difference(){
                ...
                translate([0,0,MembraneCoverHeight-2.5]){
                    Ring_Lip(   WallThickness,
                                BlowCanDiameter/2,
                                1.00, // Was 1.05 fit to loose // Fit with 1.02 seems to got to loose to , due to change in Slicer Alorithem. Classic was changed to Arachne,  
                                1.15,
                                "no"
                                );
                }
...
// Output of the text string to align the Letters semi-manual to get the Values for correct spacing around the cylinder  
